...
import { ICurrentPaintingsAction, ICurrentPaintingsArray } from "../../../types/type";

const initialState: ICurrentPaintingsArray = {
    currentPaintings: [],
}

export const currentPaintingsReducer = (state = initialState , action: ICurrentPaintingsAction): ICurrentPaintingsArray => {
    switch (action.type) {
